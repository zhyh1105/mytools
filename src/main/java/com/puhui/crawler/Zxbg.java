...
public class Zxbg {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputStream instream = new FileInputStream(new File(
				"D:/tmp/crt/ipcrs.pbccrc.org.cn.keystore"));
		try {
		...
		formparams.add(new BasicNameValuePair("_@IMGRC@_", Ocr
				.getCodeFromImage(codeFile, "mycode", true)));
		...
		get = new HttpGet(
				"https://ipcrs.pbccrc.org.cn/simpleReportAction.do?method=welcome");
		...
		get = new HttpGet(
				"https://ipcrs.pbccrc.org.cn/simpleReportAction.do?method=view&tradeCode="
						+ tradeCode + "&org.apache.struts.taglib.html.TOKEN="
						+ token);
		// get.setConfig(config);
		System.out.println(get.getURI().toString());
		response = client.execute(get);
		FileUtils.write(new File("D:/tmp/zxbg/ls.html"),
