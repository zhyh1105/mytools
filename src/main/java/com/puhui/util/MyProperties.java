...
public class MyProperties {
	private final Map<String, String> container = new LinkedHashMap<String, String>();

	private MyProperties(InputStream inputStream) throws IOException {
		load(inputStream);
	}
	...
	private Map<String, String> getContainer() {
		return container;
	}

	public static Map<String, String> getProperties(InputStream inputStream)
			throws IOException {
		return new MyProperties(inputStream).getContainer();
	}
}
