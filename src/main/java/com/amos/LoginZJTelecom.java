 ...
 */
public class LoginZJTelecom {

    public static void main(String args[]) throws Exception {
        String phone = "13336957463";
        String password = "022215";

//        String phone = "18067574041";
//        String password = "571782";


//        String phone = "15384045623";
//        String password = "343154";
        ...
        do {
            //输入验证码
            Tools.saveToLocal(httpClient.execute(new HttpGet("http://uam.ct10000.com/ct10000uam/validateImg.jsp?"+System.currentTimeMillis())).getEntity(), "zjtelecom.png");
...
//            String[] formParamterData = new String[]{"lt"};
            ...
            loginParametes.add(new BasicNameValuePair("lt", HttpParser.getValueFromStartInputByName(loginSrcHTML, "form#c2000004", "lt")));
            loginParametes.add(new BasicNameValuePair("username", phone));
            loginParametes.add(new BasicNameValuePair("password", password));
            loginParametes.add(new BasicNameValuePair("randomId", imgCode));
            loginParametes.add(new BasicNameValuePair("areaname", "浙江"));
//            loginParametes.add(new BasicNameValuePair("areaname", "%E6%B5%99%E6%B1%9F"));
            loginParametes.add(new BasicNameValuePair("customFileld02", "12"));
            loginParametes.add(new BasicNameValuePair("customFileld01", "3"));
            loginParametes.add(new BasicNameValuePair("_eventId", "submit"));
            loginParametes.add(new BasicNameValuePair("open_no", "c2000004"));
            loginParametes.add(new BasicNameValuePair("authtype", "c2000004"));
            loginParametes.add(new BasicNameValuePair("forbidpass", "null"));
            loginParametes.add(new BasicNameValuePair("forbidaccounts", "null"));
