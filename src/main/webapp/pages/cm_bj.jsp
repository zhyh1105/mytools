...
<body>
	<form id="form">
		...
		<div>验证码：<input type="text" name="rnum" value="" id="txt_rnum"/><img src="<%=request.getContextPath()%>/cm/rnum" alt="验证码" onclick="changeCodeImage(this)"></img></div>
		<div>验证码：<input type="button" id="btn_submit" value="提交"></div>
	</form>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#btn_submit").click(function(){
				...
				$.post("<%=request.getContextPath()%>/cm/bills", params, function(data){
					if(data == true){
						alert("获取账单成功");
					}else{
						alert("获取账单失败");
